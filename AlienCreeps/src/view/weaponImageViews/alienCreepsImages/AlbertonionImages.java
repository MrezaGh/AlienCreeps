...
public class AlbertonionImages {
    ...
    protected void makeFiringImages() {
        for (int i = 0; i < 3; i++) {
            String imageName = "images/Albertonion/firing" + i + ".png";
            try {
    ...
    private void makeDeadImages() {
        for (int i = 0; i < 5; i++) {
            String imageName = "images/Albertonion/dead" + i + ".png";
            try {
                Image image = new Image(new FileInputStream(imageName));
                deadImages[i] = image;
            } catch (FileNotFoundException e) {
    ...
    private void makeMoveForwardImages() {
        for (int i = 0; i < 3; i++) {
            String imageName = "images/Albertonion/moveForward" + i + ".png";
            try {
                Image image = new Image(new FileInputStream(imageName));
    ...
    private void makeMoveRightImages() {
        for (int i = 0; i < 6; i++) {
            String imageName = "images/Albertonion/moveRight" + i + ".png";
            try {
                Image image = new Image(new FileInputStream(imageName));
